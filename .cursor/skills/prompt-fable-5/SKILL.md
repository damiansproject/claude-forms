...
description: >-
  ...
  send_to_user for verbatim mid-run user content, and leave a clean
  one-pass final diff. Follow on Fable 5, multiday runs, or when Fable
  overplans, asks mid-task permission, produces unreadable summaries, or ships
